...
try {
    ...
    if (strpos($e->getMessage(), '2006') !== false || strpos($e->getMessage(), 'gone away') !== false) {
        $errorMsg = 'Error de conexión con la base de datos. Verifica que el servidor MySQL esté corriendo.';
    } elseif (strpos($e->getMessage(), 'Access denied') !== false) {
        $errorMsg = 'Error de credenciales de base de datos. Verifica la configuración.';
    } elseif (strpos($e->getMessage(), 'Unknown database') !== false) {
        $errorMsg = 'La base de datos no existe. Ejecuta crear_base_datos.php primero.';
    }
